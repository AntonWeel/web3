...
var account = null;
var contract = null;
const ADDRESS = "0xbdcd95e38e8f2a5bb78bb6967dddaf13466fcd51"
...
<div className='row'>
 <form className='gradient col-lg-5 mt-5' style={{borderRadius:"25px",boxShadow:"1px 1px 15px #000000"}}>
    <h4 style={{color:"#FFFFFF"}}>Mint Portal</h4>
    <h5 style={{color:"#FFFFFF"}}>Please connect wallet</h5>
